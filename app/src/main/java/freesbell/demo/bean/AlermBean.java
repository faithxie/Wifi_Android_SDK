...
public String toString() {
	return "AlermBean [did=" + did + ", motion_armed=" + motion_armed
			+ ", motion_sensitivity=" + motion_sensitivity + ", input_armed="
			+ input_armed + ", ioin_level=" + ioin_level + ", iolinkage="
			+ iolinkage + ", alermpresetsit=" + alermpresetsit + ", mail="
			+ mail + ", snapshot=" + snapshot + ", record=" + record
			+ ", upload_interval=" + upload_interval + ", schedule_enable="
			+ schedule_enable + ", schedule_sun_0=" + schedule_sun_0
			+ ", schedule_sun_1=" + schedule_sun_1 + ", schedule_sun_2="
			+ schedule_sun_2 + ", schedule_mon_0=" + schedule_mon_0
			+ ", schedule_mon_1=" + schedule_mon_1 + ", schedule_mon_2="
			+ schedule_mon_2 + ", schedule_tue_0=" + schedule_tue_0
			+ ", schedule_tue_1=" + schedule_tue_1 + ", schedule_tue_2="
			+ schedule_tue_2 + ", schedule_wed_0=" + schedule_wed_0
			+ ", schedule_wed_1=" + schedule_wed_1 + ", schedule_wed_2="
			+ schedule_wed_2 + ", schedule_thu_0=" + schedule_thu_0
			+ ", schedule_thu_1=" + schedule_thu_1 + ", schedule_thu_2="
			+ schedule_thu_2 + ", schedule_fri_0=" + schedule_fri_0
			+ ", schedule_fri_1=" + schedule_fri_1 + ", schedule_fri_2="
			+ schedule_fri_2 + ", schedule_sat_0=" + schedule_sat_0
			+ ", schedule_sat_1=" + schedule_sat_1 + ", schedule_sat_2="
			+ schedule_sat_2 + "]";
}
