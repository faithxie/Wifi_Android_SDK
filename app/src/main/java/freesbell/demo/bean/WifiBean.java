...
//    private int enable;
	...
	private String mIP;
	private boolean dhcp_enable,wifi_enable;
	private String netmask;
	private String gateway;
	private String dns1;
	private String dns2;
	public void SetEncrypt(String ip) {
		encrypt = ip;
	}
	public String getEncrypt() {
		return encrypt;
	}
	public void SetPasswd(String ip) {
		passwd = ip;
	}
...
//	}
	...
	public String toString() {
		return "WifiBean [did=" + did + ", enable=" + wifi_enable + ", ssid=" + ssid
