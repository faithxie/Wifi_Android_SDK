...
final class DecodeHandler extends Handler {
  ...
  DecodeHandler(CaptureActivityPortrait activity, Hashtable<DecodeHintType, Object> hints) {
...
//    System.out.println("decode...."+data.length+"\twidth:"+width+"\theight:"+height);
    ...
    if(isRotate){
    	source = CameraManager.get().buildLuminanceSource(rotateData(data, width, height), width, height);
    	isRotate=false;
    }else{
    	isRotate=true;
