...
public final class CameraManager {
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		if (camera == null) {
			...
			FlashlightManager.enableFlashlight();// 闪光灯
		}
	}

	/**
	 * Get the id of camera, default is front-camera.
	 * 
	 * @return
	 */
	private int getCameraId(boolean front) {
		...
		Log.e("info", "backCameraId:" + backCameraId + ",frontCameraId:"
				+ frontCameraId);
		if (backCameraId != -1) {
			return backCameraId;
		} else if (frontCameraId != -1) {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			// int top=screenResolution.y*1/4;
			// int buttom=screenResolution.y*3/4;
			int top = screenResolution.y / 2 - width / 2;
			int buttom = screenResolution.y / 2 + width / 2;
			Log.e("info", "x:" + screenResolution.x + ",y:"
					+ screenResolution.y);
			framingRect = new Rect(leftOffset, top, leftOffset + width, buttom);
